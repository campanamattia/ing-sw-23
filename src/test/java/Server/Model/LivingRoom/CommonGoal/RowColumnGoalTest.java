...
class RowColumnGoalTest {
    ...
    @Test
    void checkTwoRowOfDifferentColor() throws NullPlayerException {
        ...
        shelf.placeTile(new Tile(Color.YELLOW), 0, 0);
        shelf.placeTile(new Tile(Color.BLUE), 0, 1);
        shelf.placeTile(new Tile(Color.CYAN), 0, 2);
        shelf.placeTile(new Tile(Color.GREEN), 0, 3);
        shelf.placeTile(new Tile(Color.WHITE), 0, 4);

        shelf.placeTile(new Tile(Color.WHITE), 3, 0);
        shelf.placeTile(new Tile(Color.GREEN), 3, 1);
        shelf.placeTile(new Tile(Color.BLUE), 3, 2);
        shelf.placeTile(new Tile(Color.PINK), 3, 3);
    ...
    void checkOneRowOneColumnAllEquals() throws NullPlayerException {
        ...
        shelf.placeTile(new Tile(Color.CYAN), 1, 4);
        shelf.placeTile(new Tile(Color.GREEN), 2, 4);
        shelf.placeTile(new Tile(Color.BLUE), 3, 4);
        shelf.placeTile(new Tile(Color.PINK), 4, 4);
