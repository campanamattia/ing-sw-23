...
public class ThreeSimilarColumnGoal extends CommonGoal {
    private List<String> accomplished;
    private Stack<Integer> scoringToken;
    private String description;

    public ThreeSimilarColumnGoal (List<String> accomplished, Stack<Integer> scoringToken, String description) {
